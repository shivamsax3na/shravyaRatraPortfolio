...
<!-- Topbar Start -->
        ...
        <div class="row gx-0 align-items-center d-none d-lg-flex">
            <div class="col-lg-6 px-5 text-start">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="small text-secondary" href="service.html">Services</a></li>
                    <li class="breadcrumb-item"><a class="small text-secondary" href="#">Blogs</a></li>
                </ol>
            </div>
            <div class="col-lg-6 px-5 text-end">
                <small>Follow us:</small>
                <div class="h-100 d-inline-flex align-items-center">
                    ...
                    <a class="btn-square text-primary border-end rounded-0" href=""><i class="fab fa-twitter"></i></a>
                    <a class="btn-square text-primary border-end rounded-0" href=""><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn-square text-primary pe-0" href="https://instagram.com/shravyaratra?igshid=MzRlODBiNWFlZA=="><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-4 px-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="row align-items-center top-bar">
            <div class="col-lg-4 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    <h1 class="fw-bold text-primary m-0"><img src="./img/logo2.png" style="height: 8rem;" alt=""></i>Shravya Ratra</h1>
                    <!-- <img src="img/logo.png" alt="Logo"> -->
                </a>
            </div>
            <div class="col-lg-8 col-md-7 d-none d-lg-block">
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="ps-3">
                                <p class="mb-2">Connect</p>
                                <h6 class="mb-0">+91-9285034111 <br> +91-9165534469</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="ps-3">
                                ...
                                <h6 class="mb-0">ratra.shravya@gmail.com</h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="navbar-nav me-auto p-3 p-lg-0">
            ...
            <!-- <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="graphicDesignService.html">Graphic Design</a>
                  <a class="dropdown-item" href="socialMediaService.html">Social Media Marketing</a>
                  <a class="dropdown-item" href="leadGenerationService.html">Paid Advertising / Lead Generation</a>
                </div>
            </li> -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-6 mb-4">If You Have Any Query, Please Feel Free Contact</h1>
            </div>
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                    <form>
                        <div class="row g-3">
                            <form action="contact.php" method="post">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input name="companyName" type="text" class="form-control" id="subject" placeholder="Company Name">
                                        <label for="subject">Company Name</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="message" class="form-control" placeholder="How Can We Help You?" id="message" style="height: 200px"></textarea>
                                        <label for="message">How Can We Help You?</label>
                                    </div>
                                </div>
                                <div class="col-12 text-center">
                                    <button name="submitFromContact" class="btn btn-primary rounded-pill py-3 px-5" type="submit">Send Message</button>
                                </div>
                            </form>
                        </div>
                    </form>
